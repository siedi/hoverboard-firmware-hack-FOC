...
void equalize(int16_t *speedL, int16_t *speedR, int16_t *speedL_prev, int16_t *speedR_prev) {
  int diff_L = *speedL - *speedL_prev;
  int diff_R = *speedR - *speedR_prev;

  if (diff_L > 5)
    *speedL = *speedL - (diff_L*2/3); //Medium 1/2 increase, slow 1/3 increase, fast 40*ln(x) increase
